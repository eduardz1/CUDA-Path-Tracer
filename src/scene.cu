...
__host__ __device__ Scene::Scene() : width(1), height(1) {}

__host__ __device__ Scene::Scene(uint16_t width, uint16_t height)
...
__host__ __device__ auto Scene::addShape(Shape shape) -> void {
