...
auto main() -> int {
  ...
  scene->addShape(Sphere{{-1, 0, -1}, 0.5,  Metal(Vec3{0.8,0.8,0.8})});
  scene->addShape(Sphere{{1, 0, -1}, 0.5,  Metal(Vec3{0.8,0.6,0.2})});
  scene->addShape(Sphere{{0, -100.5, -1}, 100, Lambertian(Vec3{0.8,0.8,0.0})});
